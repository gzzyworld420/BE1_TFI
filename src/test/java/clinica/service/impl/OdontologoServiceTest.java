...
class OdontologoServiceTest {
  ...
  public void setUp() {
    ...
    odontologo.setApellido("Aracena");
    odontologo.setNumeroMatricula("001");
  }
  ...
  void actualizar() throws Exception {
    OdontologoDTO odontologoGuardado = odontologoService.guardar(odontologo);
    odontologoGuardado.setNombre("Lucas");
    odontologoGuardado.setApellido("Garroni");
    odontologoGuardado.setNumeroMatricula("002");
