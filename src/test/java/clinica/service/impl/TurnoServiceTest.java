...
class TurnoServiceTest {
  ...
  public void setUp() {
    ...
    domicilio.setCalle("Corrientes");
    domicilio.setNumero(6787);
    domicilio.setLocalidad("Springfield");
    domicilio.setProvincia("Springfield");
    
    paciente = new PacienteDTO();
    paciente.setNombre("Ignacio");
    paciente.setApellido("Aracena");
    paciente.setCedula("001");
    paciente.setDomicilio(domicilio);
    
    odontologo = new OdontologoDTO();
    odontologo.setNombre("Lucas");
    odontologo.setApellido("Garroni");
    odontologo.setNumeroMatricula("002");
  }
