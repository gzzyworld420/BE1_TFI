...
class TurnoControllerTest {
  ...
  void setUp() throws Exception {
    ...
    odontologo = new OdontologoDTO("001", "Ignacio", "Aracena");
    odontologoInexistente = new OdontologoDTO(999, "NN", "NN", "NN");
    odontologoExistente = new OdontologoDTO(3, "001", "Ignacio", "Aracena");
    
    DomicilioDTO domicilio = new DomicilioDTO("LAS HERAS", 420, "PALERMO", "BS AS");
    ...
    pacienteExistente = new PacienteDTO(3, "FEDERICO","VITALE","123", LocalDate.now());
    domicilio.setId(3);
